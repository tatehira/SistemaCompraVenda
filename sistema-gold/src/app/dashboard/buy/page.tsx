    ...
    return (
        <div className="flex justify-center">
            <Card className="w-full max-w-lg border-indigo-100 shadow-xl shadow-indigo-500/5 rounded-xl transition-all duration-300 hover:shadow-indigo-500/10 bg-white">
                <CardHeader>
                    <CardTitle className="text-stripe-gradient text-2xl font-bold">Nova Compra</CardTitle>
                </CardHeader>
                <CardContent>
                    <form action={action} className="grid gap-4">
                        ...
                        <Button type="submit" className="w-full bg-stripe-gradient text-white font-semibold py-6 rounded-xl shadow-lg shadow-indigo-500/20 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-indigo-500/30">Registrar Compra</Button>
                    </form>
                </CardContent>
            </Card>
        </div>
