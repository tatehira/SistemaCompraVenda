    ...
    return (
        <div className="flex justify-center">
            <Card className="w-full max-w-lg border-amber-200 shadow-xl shadow-amber-500/10 rounded-xl transition-all duration-300 hover:shadow-amber-500/20 bg-white">
                <CardHeader>
                    <CardTitle className="text-amber-600 text-2xl font-bold">Nova Venda</CardTitle>
                </CardHeader>
                <CardContent>
                    <form action={action} className="grid gap-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="delivery_courier" className="flex h-10 w-full rounded-md border border-zinc-200 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 transition-all duration-200">
                        ...
                        <Button type="submit" className="w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-semibold py-6 rounded-xl shadow-lg shadow-green-500/20 transition-all duration-300 transform hover:scale-[1.02]">Registrar Venda</Button>
                    </form>
                </CardContent>
            </Card>
        </div>
